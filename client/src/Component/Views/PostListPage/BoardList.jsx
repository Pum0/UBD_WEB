...
import {Grid ,Button, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow} from "@material-ui/core";
        ...
        if (post.writer) {
            BoardList.push(<TableBody>
                <TableRow>
                    ...
                    <TableCell component="th" scope="row"><NavLink to={`/Home/board/${post._id}`}
                                                                   key={`${post._id}`}><Typography
